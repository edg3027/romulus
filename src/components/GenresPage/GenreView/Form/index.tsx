  ...
  return (
    ...
    >
      <div className='w-full flex-1 space-y-3 overflow-auto p-4'>
        ...
        <fieldset className='rounded border border-solid border-gray-200 p-3 transition dark:border-gray-800'>
          <legend className='text-sm text-gray-700 transition dark:text-gray-300'>
            AKAs{' '}
            <a
